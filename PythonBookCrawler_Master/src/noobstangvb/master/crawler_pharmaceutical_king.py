...
"""
Description: Download "New Poke Club" online novel "The Pharmaceutical King"
Parameters: none
Returns: none
Modify: 2020-04-22
"""
...
if __name__ == "__main__":
    dl = downloader()
    dl.get_download_url()
print('"The Pharmaceutical King" starts downloading"')
for i in range(dl.nums):
    dl.writer(dl.names[i], 'pharmaceutical_king.txt', dl.get_contents(dl.urls[i]))
