...
"""
Description: Download "Poke Club" online novel "Slick Princess on Top"
Parameters: none
Returns: none
Modify: 2017-09-13
"""
class downloader(object):
    def __init__(self):
        ...
        self.target = "http://www.xbiquge.la/19/19786/";
...
if __name__ == "__main__":
    dl = downloader()
    dl.get_download_url()
print('"Slick Princess on Top" starts downloading"')
for i in range(dl.nums):
    dl.writer(dl.names[i], 'pharmaceutical_king_1.txt', dl.get_contents(dl.urls[i]))
