...
"""
Description: Download "Poke Club" online novel "Phoenix Goes Against the World"
Parameters: none
Returns: none
Modify: 2020-04-22
"""
class downloader(object):
    def __init__(self):
        ...
        self.target = "http://www.xbiquge.la/25/25784/";
...
if __name__ == "__main__":
    dl = downloader()
    dl.get_download_url()
print('"Phoenix Goes Against the World" has started downloading"')
for i in range(dl.nums):
    dl.writer(dl.names[i], 'phoenix_goes_against_the_world.txt', dl.get_contents(dl.urls[i]))
